...
type AttendeesTableFilterProps<TData> = {
    table: Table<TData>;
    filterFields: Record<string, FormInputSchemaType>;
};

function AttendeesTableFilter<TData>({ table, filterFields }: AttendeesTableFilterProps<TData>) {
                ...
                <DropdownMenuGroup>
                    {Object.entries(filterFields).map(([key, field]) => {
                        ...
                        if (field.type === FormInputTypes.RADIO || field.type === FormInputTypes.SELECT) {
                            return <RadioAndSelectFilter key={key} table={table} fieldKey={key} fieldTitle={i18n.language === "en-US" ? field.titleEN : field.titleAR} fieldData={field} filterValue={filterValue} />;
                        }

                        if (field.type === FormInputTypes.CHECKBOX) {
                            return <CheckboxFilter key={key} table={table} fieldKey={key} fieldTitle={i18n.language === "en-US" ? field.titleEN : field.titleAR} fieldData={field} filterValue={filterValue} />;
                        }

                        if (field.type === FormInputTypes.DATE) {
                            return <DateFilter key={key} table={table} fieldKey={key} fieldTitle={i18n.language === "en-US" ? field.titleEN : field.titleAR} fieldData={field} filterValue={filterValue} />;
                        }

                        if (field.type === FormInputTypes.NUMBER) {
                            return <NumberFilter key={key} table={table} fieldKey={key} fieldTitle={i18n.language === "en-US" ? field.titleEN : field.titleAR} fieldData={field} filterValue={filterValue} />;
                        }
...
export default AttendeesTableFilter;
