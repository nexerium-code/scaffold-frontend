...
type AttendeesTableFilterAttendedProps<TData> = {
    table: Table<TData>;
};

function AttendeesTableFilterAttended<TData>({ table }: AttendeesTableFilterAttendedProps<TData>) {
        ...
        <Tooltip>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="start">
                    <DropdownMenuLabel>{t("filter-attended")}</DropdownMenuLabel>
...
export default AttendeesTableFilterAttended;
