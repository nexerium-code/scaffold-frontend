...
type FeedbackTableFilterPublishedProps<TData> = {
    table: Table<TData>;
};

function FeedbackTableFilterPublished<TData>({ table }: FeedbackTableFilterPublishedProps<TData>) {
...
export default FeedbackTableFilterPublished;
