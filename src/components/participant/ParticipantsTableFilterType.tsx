...
interface ParticipantsTableFilterTypeProps<TData> {
    table: Table<TData>;
}

function ParticipantsTableFilterType<TData>({ table }: ParticipantsTableFilterTypeProps<TData>) {
...
export default ParticipantsTableFilterType;
