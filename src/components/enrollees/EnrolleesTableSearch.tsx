...
type EnrolleesTableSearchProps<TData> = {
    table: Table<TData>;
    searchFields?: string[];
};

function EnrolleesTableSearch<TData>({ table, searchFields = ["name", "email", "phone"] }: EnrolleesTableSearchProps<TData>) {
    ...
    return (
        <InputGroup className="max-w-sm">
            ...
            <InputGroupInput placeholder={`Search ${target}...`} value={filterValue} onChange={(e) => handleSearch(e.target.value)} />
...
export default EnrolleesTableSearch;
