...
type AttendeesTableSearchProps<TData> = {
    table: Table<TData>;
...
function AttendeesTableSearch<TData>({ table, searchFields }: AttendeesTableSearchProps<TData>) {
...
export default AttendeesTableSearch;
