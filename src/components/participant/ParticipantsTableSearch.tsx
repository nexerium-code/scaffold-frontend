...
type ParticipantsTableSearchProps<TData> = {
    table: Table<TData>;
    searchFields?: string[];
};

function ParticipantsTableSearch<TData>({ table, searchFields = ["name", "email", "phone", "reference"] }: ParticipantsTableSearchProps<TData>) {
...
export default ParticipantsTableSearch;
