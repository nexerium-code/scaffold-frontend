...
type ParticipantsTableFilterApprovedProps<TData> = {
    table: Table<TData>;
};

function ParticipantsTableFilterApproved<TData>({ table }: ParticipantsTableFilterApprovedProps<TData>) {
...
export default ParticipantsTableFilterApproved;
