...
const Squares: React.FC<SquaresProps> = ({ direction = "right", speed = 1, borderColor = "#1f40ad1c", squareSize = 40, hoverFillColor = "#1449e642" }) => {
    ...
    useEffect(() => {
        ...
        const drawGrid = () => {
            ...
            gradient.addColorStop(0, theme === "dark" ? "rgba(0, 0, 0, 0)" : "rgba(255, 255, 255, 0)");
